...
func PowerStationIdJSON(userLogin *SemsLoginCredentials) ([]byte, error) {
...
// Returns a byte slice and an error.
func DataTokenJSON(semsResponseData *SemsLoginResponse) ([]byte, error) {
	// Use struct for better performance and type safety
	tokenData := struct {
...
// It takes a pointer to an ApiLoginResponse struct 'semsResponseData' as a parameter.
// Returns a byte slice and an error.
func PowerPlantdataTokenJSON(semsResponseData *SemsLoginResponse) ([]byte, error) {
	// Use struct for better performance and type safety
	tokenData := struct {
		ID   string `json:"id"`
